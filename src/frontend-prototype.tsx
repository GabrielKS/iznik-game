        ...
        <div className="board">
            <div className="tile-area">
                ...
                <div className="stages">
                    <TileRow tiles={1} className="row1" />
                    <TileRow tiles={2} className="row2" />
                    <TileRow tiles={3} className="row3" />
                    <TileRow tiles={4} className="row4" />
                    <TileRow tiles={5} className="row5" />
                </div>
                <div className="arrows">
                    <Arrow className="row1"/>
                    <Arrow className="row2"/>
                    <Arrow className="row3"/>
                    <Arrow className="row4"/>
                    <Arrow className="row5"/>
                </div>
                <TileGrid rows={5} cols={5} className="panel" />
            </div>
            <div className="floor-area">
                <TileRow tiles={7} className="floor" />
...
function TileRow(props) {
    let tiles = [];
    for (let i = 0; i < props.tiles; i++) {
        tiles.push(<div key={i} className="tile-spot square"></div>);
    }
    return <div className={props.className+" tile-row"}>{tiles}</div>;
}
...
function TileGrid(props) {
    ...
    for (let i = 0; i < props.rows; i++) {
        ...
        for (let j = 0; j < props.cols; j++) {
            tiles[i].push(<div key={i+","+j} className={"tile-spot square row"+(i+1)+" col"+(j+1)}></div>);
        }
    }
    return <div className={props.className+" tile-grid"}>{tiles}</div>
}

function Arrow(props) {
    return <div className={props.className+" arrow square"}></div>
}
